...
const (
	gatewayName               = "gateway_cosmos_linux-amd64"
	bridgeName                = "bridge_cosmos_linux-amd64"
	gatewayProgramName        = "gatewaycosmos"
	bridgeProgramName         = "bridgecosmos"
	defaultUser               = "root"
	supervisorConfFiles       = "/etc/supervisor/conf.d"
	gatewaySupervisorConfFile = "gatewaycosmos"
	bridgeSupervisorConfFile  = "bridgecosmos"
	logRootDir                = "/var/log/supervisor"
	oldLogRootDir             = "/var/log/old_logs"
	projectName               = "gateway_cosmos"
)
