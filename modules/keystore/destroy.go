...
func Destroy(keystoreDir string) error {

	kstore := ethKeystore.NewKeyStore(keystoreDir, ethKeystore.StandardScryptN, ethKeystore.StandardScryptP)
	if len(kstore.Accounts()) == 0 {
		return errors.New("No keystore found")
	}
